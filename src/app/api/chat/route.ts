...
**Strong fit domains:** Senior product and strategy mandates for scale-ups (product strategy, architecture decisions, roadmap sharpening, GTM validation, ops audits, management/investor reporting), co-builder mandates for pre-seed to seed founders (pitch deck, financial model, TAM/SAM/SOM validation, investor relations, outreach sequence), agentic engineering with Claude Code/Cursor/MCP for end-to-end product delivery (BauPilot RAG platform for German planning law shipped solo in 2 months, ertragwerk.de real estate SaaS shipped solo in 1 month), hyper-growth operational substance (Gorillas 20-to-150 store rollout, 130 use-permit conversions, €2M buildout budget across 16 German federal states), post-merger integration (90+ DACH property wind-down after Getir acquisition), startup sparring delivery (GRÜNZUCKER, LAP Coffee, Halo Bagels, Everyfy), no-code automation (Airtable, Zapier, Make), Shopify, change management for German Mittelstand (BEC-Energie), AI workshop enablement, stakeholder management with authorities/landlords/C-level, project management (PSM I).

**Partial fit (transferable):** Multi-site operations consulting (track record exists from Gorillas — Pre-LOI checks, lease redlines, use-permit conversions — but Lukas no longer leads with this as a sold service), data analysis (Excel advanced, SQL/Power BI basics), data architecture for B2B SaaS (RAG/PostGIS in BauPilot), e-commerce operations, fintech operations (Solarisbank).
